...
/**
 * This is the item provider adapter for a {@link edu.isistan.reassistant.model.Identifiable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentifiableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 REAssistantModelPackage.Literals.IDENTIFIABLE__ID,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Identifiable.class)) {
			case REAssistantModelPackage.IDENTIFIABLE__ID:
	...
	public ResourceLocator getResourceLocator() {
		return ReassistantEditPlugin.INSTANCE;
	}
