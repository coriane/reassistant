...
public class SRLSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SRLPackage.ARGUMENT: {
				Argument argument = (Argument)theEObject;
				T result = caseArgument(argument);
				if (result == null) result = caseIdentifiableAnnotation(argument);
				if (result == null) result = caseAnnotation(argument);
				if (result == null) result = caseAnnotationBase(argument);
				if (result == null) result = caseTOP(argument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SRLPackage.PREDICATE: {
				Predicate predicate = (Predicate)theEObject;
				T result = casePredicate(predicate);
				if (result == null) result = caseIdentifiableAnnotation(predicate);
				if (result == null) result = caseAnnotation(predicate);
				if (result == null) result = caseAnnotationBase(predicate);
				if (result == null) result = caseTOP(predicate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SRLPackage.ROLE: {
				Role role = (Role)theEObject;
				T result = caseRole(role);
				if (result == null) result = caseIdentifiableAnnotation(role);
				if (result == null) result = caseAnnotation(role);
				if (result == null) result = caseAnnotationBase(role);
				if (result == null) result = caseTOP(role);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SRLPackage.STRUCTURE: {
				Structure structure = (Structure)theEObject;
				T result = caseStructure(structure);
				if (result == null) result = caseIdentifiableAnnotation(structure);
				if (result == null) result = caseAnnotation(structure);
				if (result == null) result = caseAnnotationBase(structure);
				if (result == null) result = caseTOP(structure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
