 ...
 * $Id$
 */
package edu.isistan.uima.unified.typesystems.srs.util;
...
public class SRSSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SRSPackage.DOCUMENT: {
				Document document = (Document)theEObject;
				T result = caseDocument(document);
				if (result == null) result = caseIdentifiableAnnotation(document);
				if (result == null) result = caseAnnotation(document);
				if (result == null) result = caseAnnotationBase(document);
				if (result == null) result = caseTOP(document);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SRSPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = caseIdentifiableAnnotation(project);
				if (result == null) result = caseAnnotation(project);
				if (result == null) result = caseAnnotationBase(project);
				if (result == null) result = caseTOP(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SRSPackage.SECTION: {
				Section section = (Section)theEObject;
				T result = caseSection(section);
				if (result == null) result = caseIdentifiableAnnotation(section);
				if (result == null) result = caseAnnotation(section);
				if (result == null) result = caseAnnotationBase(section);
				if (result == null) result = caseTOP(section);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
