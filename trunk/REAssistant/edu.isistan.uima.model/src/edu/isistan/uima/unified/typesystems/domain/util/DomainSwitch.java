...
public class DomainSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DomainPackage.DOMAIN_ACTION: {
				...
				if (result == null) result = caseIdentifiableAnnotation(domainAction);
			...
			case DomainPackage.DOMAIN_NUMBER: {
				DomainNumber domainNumber = (DomainNumber)theEObject;
				T result = caseDomainNumber(domainNumber);
				if (result == null) result = caseIdentifiableAnnotation(domainNumber);
				if (result == null) result = caseAnnotation(domainNumber);
				if (result == null) result = caseAnnotationBase(domainNumber);
				if (result == null) result = caseTOP(domainNumber);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDomainNumber(DomainNumber object) {
		return null;
	}
