 ...
 * $Id$
 */
package edu.isistan.uima.unified.typesystems.util;
 ...
 * @generated
 */
public class TypesystemsSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static TypesystemsPackage modelPackage;
	 ...
	 * @generated
	 */
	public TypesystemsSwitch() {
		if (modelPackage == null) {
			modelPackage = TypesystemsPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TypesystemsPackage.IDENTIFIABLE_ANNOTATION: {
				IdentifiableAnnotation identifiableAnnotation = (IdentifiableAnnotation)theEObject;
				T result = caseIdentifiableAnnotation(identifiableAnnotation);
				if (result == null) result = caseAnnotation(identifiableAnnotation);
				if (result == null) result = caseAnnotationBase(identifiableAnnotation);
				if (result == null) result = caseTOP(identifiableAnnotation);
