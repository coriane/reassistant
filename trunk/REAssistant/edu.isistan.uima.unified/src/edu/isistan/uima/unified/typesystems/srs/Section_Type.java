...
/** 
 * Updated by JCasGen Fri Mar 11 15:23:12 ART 2011
 * @generated */
public class Section_Type extends IdentifiableAnnotation_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.isistan.uima.unified.typesystems.srs.Section");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.isistan.uima.unified.typesystems.srs.Section");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "edu.isistan.uima.unified.typesystems.srs.Section");
  ...
  public String getKind(int addr) {
      ...
      jcas.throwFeatMissing("kind", "edu.isistan.uima.unified.typesystems.srs.Section");
