...
public class SRSWizardInitialObjectCreationPage extends WizardPage {
	public static final String ID = "edu.isistan.srseditor.wizards.SRSWizardInitialObjectCreationPage"; //$NON-NLS-1$
	 ...
	 * Create the wizard.
	 */
	public SRSWizardInitialObjectCreationPage(String pageId) {
		super(pageId);
	}
	...
	public void createControl(Composite parent) {
		...
		{
			labelName.setText(Messages.SRSWizard_ProjectName);
		...
		textName.setText(Messages.SRSWizard_DefaultProjectName);
		{
		...
		{
			labelContent.setText(Messages.SRSWizard_ProjectContent);
		...
		textContent.setText(Messages.SRSWizard_DefaultProjectContent);
		{
		...
		{
			labelEncoding.setText(Messages.SRSWizard_XMLEncoding);
	...
	protected Collection<String> getEncodings() {
		if (encodings == null) {
			...
			for (StringTokenizer stringTokenizer = new StringTokenizer(Messages.SRSWizard_XMLEncodingChoices); stringTokenizer.hasMoreTokens(); ) {
