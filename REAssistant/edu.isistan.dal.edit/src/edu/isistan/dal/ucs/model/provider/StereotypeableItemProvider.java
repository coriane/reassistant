...
/**
 * This is the item provider adapter for a {@link edu.isistan.dal.ucs.model.Stereotypeable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StereotypeableItemProvider
	 ...
	 * @generated
	 */
	public StereotypeableItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((Stereotypeable)object).getStereotype();
		return label == null || label.length() == 0 ?
			getString("_UI_Stereotypeable_type") :
			getString("_UI_Stereotypeable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Stereotypeable.class)) {
			case UCSModelPackage.STEREOTYPEABLE__STEREOTYPE:
